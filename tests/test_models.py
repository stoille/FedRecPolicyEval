...
class TestVAE:
    ...
    def eval_vae_loss(self, vae_model):
        x = torch.rand(32, 100)
...
class TestMatrixFactorization:
    def eval_mf_initialization(self, mf_model):
    ...
    def eval_mf_forward(self, mf_model):
